...
const AboutPage = () => {
  ...
  return (
    <>
      ...
      {/* Content Section */}
      <div className="max-w-screen-xl mx-auto font-ibm rounded-lg shadow-lg py-8 px-4 md:px-8 lg:px-10">
        ...
        {/* Programs Section */}
        <div className="flex flex-col md:flex-row justify-between items-stretch mt-8 space-y-4 md:space-y-0 md:space-x-4">
