    ...
    return (
        <section className="lg:flex lg:justify-center w-full mb-20">
            <div className="w-full flex flex-col-reverse justify-center items-center md:flex-row md:container">
              <div className="relative sm:text-center items-center md:text-start left-0 bottom-16 md:bottom-0 bg-black text-white flex flex-col justify-evenly px-5 py-5 w-[85%] md:w-[40%] md:left-12">
