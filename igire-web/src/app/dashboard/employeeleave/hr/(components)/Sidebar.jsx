      ...
      >
        ...
        <div className="flex-grow">
          <SidebarLink
            ...
            label="Dashboard"
          />
          <SidebarLink href="/dashboard/employeeleave/hr/leaverequest" icon={Archive} label="Leave Request" />
          <SidebarLink href="/dashboard/employeeleave/hr/leavecancelation" icon={Archive} label="Leave Cancelation" />
          <SidebarLink
          ...
          <SidebarLink
            href="/dashboard/employeeleave/hr/settings"
